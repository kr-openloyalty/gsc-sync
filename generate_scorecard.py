...
GSC_C1 = {
    "loyalty program software":
        [3.2,3.2,2.9,2.3,2.0,2.0,2.2,2.3,1.9,2.5,2.7,2.7,4.1,4.1,5.9],
    "customer loyalty program software":
        [7.7,3.3,6.2,4.2,2.4,2.3,2.8,3.8,2.3,6.2,6.4,3.4,5.6,5.2,8.4],
    "loyalty software":
        [6.2,3.4,5.8,3.6,2.0,1.6,2.1,2.6,1.6,1.6,1.6,2.0,4.1,3.1,4.5],
    "best loyalty program software":
        [1.0,1.4,1.0,2.6,2.6,3.3,2.9,1.6,3.7,3.9,3.5,1.2,1.7,1.5,3.8],
    "enterprise loyalty software":
        [3.2,1.8,2.5,2.5,2.8,4.5,3.0,2.7,1.7,4.1,2.5,2.2,3.2,3.4,3.1],
    "best customer loyalty program software":
        [1.4,1.2,1.1,2.3,2.0,2.5,2.7,2.4,2.2,2.3,2.1,2.4,4.1,7.3,5.3],
    "best loyalty software":
        [1.0,1.5,1.0,3.0,3.3,3.6,3.3,1.8,3.2,4.2,2.6,1.1,4.1,3.4,8.8],
    "loyalty software for business":
        [7.2,3.0,5.5,4.6,4.0,5.5,4.0,4.0,10.0,8.0,6.0,6.0,6.0,7.0,None],
}

GSC_C2 = {
    "customer loyalty software":
        [5.2,2.5,4.7,3.3,2.2,2.0,2.7,3.5,2.2,2.2,2.2,3.5,3.0,3.5,3.1],
    "loyalty management software":
        [9.4,8.0,11.0,5.1,5.0,3.8,4.3,3.1,2.7,2.7,3.5,3.1,3.3,3.1,3.7],
    "loyalty program management software":
        [9.7,6.2,9.4,2.9,2.9,3.6,3.6,2.5,2.2,2.4,2.5,2.6,2.4,2.8,2.6],
    "loyalty management system":
        [10.7,10.9,9.6,7.9,4.9,6.6,5.1,5.9,7.8,3.4,3.8,5.0,6.7,5.5,8.4],
    "gamification software":
        [2.9,21.0,23.0,14.3,12.2,17.8,20.6,24.0,25.5,25.4,27.4,25.7,33.9,32.0,38.4],
    "retail loyalty software":
        [4.1,3.7,4.5,1.1,1.7,2.9,2.6,2.6,1.3,3.5,3.2,2.2,1.6,2.5,2.7],
    "loyalty points software":
        [3.4,3.6,3.7,4.3,4.4,4.6,4.5,4.3,4.4,5.3,5.0,4.7,4.5,5.5,10.5],
}
